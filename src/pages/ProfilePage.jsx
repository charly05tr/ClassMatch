...
import { faTrashCan, faArrowLeft, faArrowRight } from '@fortawesome/free-solid-svg-icons'
...
function ProfilePage({ onLogout, id: propId, isMatched}) {
    const params = useParams();
    const id = params.id ? params.id: propId;
                    ...
                    <div className="w-full grid grid-cols-[auto_1fr]">
                        ...
                        <h2 className='text-white-400 font-light text-4xl'>Portfolio</h2>}
                        {
                            (isOwner && String(id) === String(currentUserId))
                                ...
                                )) : (state && isMatched) ? (<div className='flex flex-row justify-end gap-2 fixed'>
