...
const API_BASE_URL = 'http://192.166.0.4:5000'; // Ajusta esto a la URL de tu backend Flask
const WEBSOCKET_URL = 'http://192.166.0.4:5000'; // Ajusta esto a la URL de tu backend SocketIO
